// CPostman.h: interface for the Smtp class.
//
//////////////////////////////////////////////////////////////////////
...
public:
	...
	CExceptionSmtp(MSmtpError err_) : m_errorCode(err_) {}

	MSmtpError GetErrorCode(void) const 
	{ 
		return m_errorCode; 
	}
...
typedef struct tagCommand_Entry
{
	...
	CExceptionSmtp::MSmtpError error;
}Command_Entry;
...
public:
	...
	bool ConnectToSmtpServer(
		const char* szServer,
		const unsigned short smtpPortNum_ = 0,
