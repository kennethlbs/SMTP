...
struct SMail
{
	static const int m_stringLength = 50;
	char m_smtpLoginUsername[m_stringLength];
	char m_smtpLoginPsd[m_stringLength];
	char m_senderName[m_stringLength];
	char m_senderEmailAddr[m_stringLength];
	char m_replyToEmailAddr[m_stringLength];
	char m_emailSubject[m_stringLength];
};
...
int main()
{
	...
	try
	{
		...
		mail.SetReplyTo("xxx@lazybugstudio.com");
